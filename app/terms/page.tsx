    ...
    <footer className="bg-[#0B1326] py-12 mt-auto border-t border-white/5 text-sm tracking-wide uppercase font-semibold">
      <div className="flex flex-col md:flex-row justify-between items-center px-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-6 md:mb-0">
          <Link href="/privacy" className="text-white hover:text-[#44E2CD] transition-colors duration-200">
            Privacy Policy
          </Link>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 text-center md:text-left">
            <div className="inline-block px-3 py-1 rounded-full bg-surface-container-high border border-outline-variant/15 mb-4">
              <span className="text-secondary text-[10px] uppercase font-bold tracking-[0.2em]">
                Legal Document
              </span>
            </div>
          ...
          <div className="space-y-16">
            ...
            <section id="acceptance" className="group">
              <div className="flex items-start gap-6">
                <span className="text-secondary font-black text-2xl opacity-50 group-hover:opacity-100 transition-opacity">
                  01.
                </span>
                <div>
                  ...
                  <div className="space-y-4 text-on-surface-variant leading-relaxed">
                    <p>
                      ...
                      age and possess the legal authority to enter into this binding agreement. If
                      you are using SubSnap on behalf of an entity, you represent that you have the
                      authority to bind that entity to these terms.
                    </p>
                    <p>
                      We reserve the right to update these terms at any time. Significant changes
                      will be communicated via the email address associated with your account or
                      through a prominent notice within the application shell.
                    </p>
                  </div>
                </div>
              </div>
                      ...
                      <div className="flex gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-on-surface-variant">
                            ...
                            submission, and manual "Best Effort" intervention for legacy providers.
                          </p>
                        </div>
                      </div>
                      <div className="flex gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-on-surface-variant">
                            ...
                            cancellation on all platforms. Our service is provided on a "Best
                            Effort" basis.
                          </p>
                        </div>
                      </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <p className="text-on-surface-variant leading-relaxed">
                      ...
                      non-refundable except where required by law. By providing a payment method,
                      you authorize SubSnap to charge the applicable fees to that payment instrument.
                    </p>
            ...
            <section id="privacy" className="group">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant leading-relaxed mb-6">
                    Your privacy is managed under our Privacy Policy. By using SubSnap, you
                    acknowledge that we process your uploaded bank statement locally in your browser
                    to identify recurring subscriptions. We never store your bank login credentials.
                  </p>
                  <Link
                    href="/privacy"
